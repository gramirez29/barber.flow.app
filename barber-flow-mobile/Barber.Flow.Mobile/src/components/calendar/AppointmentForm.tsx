    ...
    <>
      <View style={styles.formGroup}>
        ...
        <SegmentedButtons
          ...
          buttons={[
            {
              label: translateText("calendar.appointmentModal.statuses.scheduled"),
              value: "scheduled",
            },
            {
              label: translateText("calendar.appointmentModal.statuses.confirmed"),
              value: "confirmed",
            },
            {
              label: translateText("calendar.appointmentModal.statuses.completed"),
              value: "completed",
            },
            {
              label: translateText("calendar.appointmentModal.statuses.cancelled"),
              value: "cancelled",
            },
          ]}
        />
      ...
      <View style={styles.formGroup}>
        ...
        <HelperText
          type="error"
          visible={Boolean(touched.clientName && errors.clientName)}
        >
      ...
      <View style={styles.formGroup}>
        ...
        <HelperText
          type="error"
          visible={Boolean(touched.servicePrice && errors.servicePrice)}
        >
      ...
      <View style={styles.formGroup}>
        ...
        <HelperText
          type="error"
          visible={Boolean(touched.paymentMethodUsed && errors.paymentMethodUsed)}
        >
