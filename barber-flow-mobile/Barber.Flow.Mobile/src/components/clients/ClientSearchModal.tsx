		...
		<Portal>
			...
			>
				...
				<View style={styles.searchWrap}>
					...
					>
						{loading ? (
							<ActivityIndicator size={18} color={theme.colors.accent} />
						) : (
							<Ionicons name="arrow-forward-circle" size={26} color={theme.colors.accent} />
						)}
					</Pressable>
				</View>
						...
						return (
							...
							>
								...
								<View style={styles.cardActions}>
									...
									>
										<Ionicons name="checkmark-circle-outline" size={14} color={theme.colors.background} />
