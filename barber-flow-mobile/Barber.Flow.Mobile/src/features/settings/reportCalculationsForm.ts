...
export type ReportCalculationSettingErrors = Partial<Record<keyof ReportCalculationSettings, string>>;

export type ReportCalculationSettingTouched = Partial<Record<keyof ReportCalculationSettings, boolean>>;
