	...
	appointments: {
		...
		alerts: {
			...
			noScheduledIfCompleted: "Cannot schedule a completed appointment.",
			noConfirmedIfCancelled: "Cannot confirm a cancelled appointment.",
	...
	calendar: {
		...
		appointmentModal: {
			...
			readOnlyInfo: "This appointment is Completed or Cancelled and can no longer be edited.",
